...
<section class="houses pad" id="houses" data-screen-label="Houses">
  <div class="wrap">
    <div class="section-head reveal">
      <div class="overline"><?= $p['houses_over'] ?></div>
      <h2><?= $p['houses_h2'] ?></h2>
      <p><?= $p['houses_p'] ?></p>
    </div>
...
<section class="services pad" id="services" data-screen-label="Services">
  <div class="wrap">
    <div class="section-head reveal">
      <div class="overline"><?= $p['services_over'] ?></div>
      <h2><?= $p['services_h2'] ?></h2>
    </div>
    <div class="svc-grid">
...
<section class="offers" id="offers" data-screen-label="Offers">
  <div class="wrap inner reveal">
    <div class="overline"><?= $p['offers_over'] ?></div>
    <h2><?= $p['offers_h2'] ?></h2>
    <p class="body-text" style="margin:0 auto 36px;color:rgba(255,255,255,.88);max-width:50ch;"><?= $p['offers_p'] ?></p>
