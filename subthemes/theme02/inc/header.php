        ...
        <div class="has-sub">
          ...
          <div class="sub">
            <?php foreach ($item['sub'] as $s): ?>
              ...
              <a href="<?php echo $s['url'] ?>"><span class="t"><?php echo $s['label'] ?></span><span class="d"><?php echo $s['desc'] ?></span></a>
            <?php endforeach; ?>
          </div>
        </div>
      <?php else: ?>
        <a href="<?php echo $item['url'] ?>"<?php echo $PAGE === $item['key'] ? ' class="current"' : '' ?>><?php echo $item['label'] ?></a>
      <?php endif; ?>
    <?php endforeach; ?>
    <?php endif; ?>
  </nav>
...
<div class="drawer" id="drawer">
  ...
  <?php foreach ($NAV as $item): ?>
    ...
    <?php if (!empty($item['sub'])): ?>
      <div class="sub-m">
        <?php foreach ($item['sub'] as $s): ?><a href="<?php echo $s['url'] ?>"><?php echo $s['label'] ?></a><?php endforeach; ?>
      </div>
    <?php endif; ?>
  <?php endforeach; ?>
</div>
