...
<footer data-screen-label="Footer">
  <div class="wrap">
    <div class="foot-grid">
      <div class="reveal">
        <a class="logo" href="index.php"><img src="<?= $IMG['logo_foot'] ?>" alt="<?= $SITE['name'] ?>" /></a>
      </div>
      <div class="reveal">
        <h4><?= $SITE['name'] ?></h4>
...
<script src="<?= function_exists('sbt_asset_url') ? sbt_asset_url('assets/theme.js') : 'assets/theme.js' ?>"></script>
