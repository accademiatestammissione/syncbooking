...
<section class="sbtw-page-hero" data-screen-label="Offers banner">
  <?php echo sbt_t1_img( 'C.offers.image_1', sbt_t1_asset( 'assets/images/aerial-pool.jpg' ), '', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
    <div class="sbtw-overline"><?php echo sbt_t1_text( 'C.offers.text_1', 'Masseria Le Cerase offers', array( 'multiline' => false ) ); ?></div>
...
<section class="sbtw-pad" data-screen-label="Offers intro">
  <div class="sbtw-wrap">
    ...
    <div class="sbtw-offer-grid">
      <a class="sbtw-offer-card sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.offers.link_2', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.offers.image_2', sbt_t1_asset( 'assets/images/bedroom-2.jpg' ), '', array() ); ?><div class="sbtw-oc-body"><span class="sbtw-badge"><?php echo sbt_t1_text( 'C.offers.text_8', 'Early booking', array( 'multiline' => false ) ); ?></span><h3><?php echo sbt_t1_text( 'C.offers.text_9', 'Book Early, Save More', array( 'multiline' => false ) ); ?></h3><p><?php echo sbt_t1_text( 'C.offers.text_10', 'Reserve well in advance and enjoy a special rate on your favourite house.', array( 'multiline' => false ) ); ?></p></div></a>
      <a class="sbtw-offer-card sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.offers.link_3', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.offers.image_3', sbt_t1_asset( 'assets/images/courtyard.jpg' ), '', array() ); ?><div class="sbtw-oc-body"><span class="sbtw-badge"><?php echo sbt_t1_text( 'C.offers.text_11', 'Long stay', array( 'multiline' => false ) ); ?></span><h3><?php echo sbt_t1_text( 'C.offers.text_12', '7 Nights = 6', array( 'multiline' => false ) ); ?></h3><p><?php echo sbt_t1_text( 'C.offers.text_13', 'Stay a week and pay for six nights — the perfect way to truly unwind in Puglia.', array( 'multiline' => false ) ); ?></p></div></a>
      <a class="sbtw-offer-card sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.offers.link_4', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.offers.image_4', sbt_t1_asset( 'assets/images/jacuzzi.jpg' ), '', array() ); ?><div class="sbtw-oc-body"><span class="sbtw-badge"><?php echo sbt_t1_text( 'C.offers.text_14', 'Wellness', array( 'multiline' => false ) ); ?></span><h3><?php echo sbt_t1_text( 'C.offers.text_15', 'SPA Escape', array( 'multiline' => false ) ); ?></h3><p><?php echo sbt_t1_text( 'C.offers.text_16', 'A romantic stay for two with a dedicated wellness experience in our SPA.', array( 'multiline' => false ) ); ?></p></div></a>
      <a class="sbtw-offer-card sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.offers.link_5', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.offers.image_5', sbt_t1_asset( 'assets/images/aerial-pool.jpg' ), '', array() ); ?><div class="sbtw-oc-body"><span class="sbtw-badge"><?php echo sbt_t1_text( 'C.offers.text_17', 'Season', array( 'multiline' => false ) ); ?></span><h3><?php echo sbt_t1_text( 'C.offers.text_18', 'Spring &amp; Autumn', array( 'multiline' => false ) ); ?></h3><p><?php echo sbt_t1_text( 'C.offers.text_19', 'Discover Puglia in its gentlest seasons with our reduced shoulder-season rates.', array( 'multiline' => false ) ); ?></p></div></a>
    </div>
  </div>
</section>

<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_t1_asset( 'assets/images/bedroom-2.jpg' ) ); ?>');" data-screen-label="Offers CTA">
