...
<section class="sbtw-page-hero" data-screen-label="Contacts banner">
  <?php echo sbt_t1_img( 'C.contacts.hero_bg', sbt_gallery_src( ( isset( $C['contacts']['hero_bg'] ) && $C['contacts']['hero_bg'] !== '' ) ? $C['contacts']['hero_bg'] : 'facade-vines.jpg' ), $SITE['name'] ?? 'Contacts', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
    ...
    <div class="sbtw-contact-grid">
      <div class="sbtw-contact-info sbtw-reveal">
        <div class="sbtw-ci-block">
          ...
          <p class="sbtw-big"><?php echo wp_kses( $SITE['address'] ?? 'Via Martuccello n. 8<br/>70014 Conversano (Bari)<br/>Puglia, Italy', array( 'br' => array() ) ); ?></p>
...
<section style="padding-bottom:0;" data-screen-label="Contacts map">
  <iframe class="sbtw-map-embed" src="<?php echo esc_url( $SITE['map_embed'] ?? 'https://www.google.com/maps?q=Masseria%20Le%20Cerase%20Conversano&output=embed' ); ?>" title="Map" loading="lazy"></iframe>
</section>
