...
<section class="sbtw-page-hero" data-screen-label="Villa banner">
  <img class="sbtw-bg" src="<?php echo esc_url( sbt_asset_url( 'assets/images/aerial-pool.jpg' ) ); ?>" alt="Masseria Le Cerase" />
  <div class="sbtw-wrap">
...
<section class="sbtw-pad" data-screen-label="Villa intro">
  <div class="sbtw-wrap sbtw-two-col">
    ...
    <div class="sbtw-reveal">
      ...
      <p class="sbtw-body-text" style="max-width:54ch;margin-top:18px;">Attention to detail, refined design, a mix of modern and ancient, a stone's throw from monuments and shops — the rooms of Masseria Le Cerase, with private external pergolas, also offer the typical comforts of a resort.</p>
    </div>
  </div>
</section>
...
<section class="sbtw-pad-s" style="padding-top:0;" data-screen-label="Villa gallery">
  <div class="sbtw-wrap">
    <div class="sbtw-gallery">
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/pool-pergola.jpg' ) ); ?>" alt="Masseria Le Cerase interior" />
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/living-1.jpg' ) ); ?>" alt="Masseria Le Cerase detail" />
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/bedroom-1.jpg' ) ); ?>" alt="Masseria Le Cerase room" />
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/bedroom-2.jpg' ) ); ?>" alt="Masseria Le Cerase living" />
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/courtyard.jpg' ) ); ?>" alt="Masseria Le Cerase garden" />
      <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/aerial-pool.jpg' ) ); ?>" alt="Masseria Le Cerase pool" />
    </div>
  </div>
</section>
...
<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_asset_url( 'assets/images/bedroom-2.jpg' ) ); ?>');" data-screen-label="Villa CTA">
  <div class="sbtw-inner sbtw-reveal">
    ...
    <h2>Choose your room in Masseria Le Cerase</h2>
