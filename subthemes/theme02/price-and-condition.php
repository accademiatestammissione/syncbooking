...
<section class="sbtw-page-hero" data-screen-label="Price banner">
  <img class="sbtw-bg" src="<?php echo esc_url( sbt_asset_url( 'assets/images/courtyard.jpg' ) ); ?>" alt="Price & Condition" />
  <div class="sbtw-wrap">
...
<section class="sbtw-pad" data-screen-label="Price intro">
  <div class="sbtw-wrap">
    <div class="sbtw-section-head sbtw-reveal">
      ...
      <p>Check live availability and the best rates for each room, then confirm your reservation in a few secure steps — instant booking, no waiting for a reply.</p>
    </div>
    <div class="sbtw-book-cta sbtw-reveal">
      <div class="sbtw-bc-text">
        ...
        <p>Select your room, see live prices for your dates and complete your reservation through our secure booking system.</p>
      </div>
