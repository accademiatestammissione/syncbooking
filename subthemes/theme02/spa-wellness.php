...
<section class="sbtw-page-hero" data-screen-label="SPA banner">
  ...
  <div class="sbtw-wrap">
    <div class="sbtw-overline"><?php echo sbt_t1_text( 'C.spa.text_1', 'Masseria Le Cerase &amp; SPA', array( 'multiline' => false ) ); ?></div>
...
<section class="sbtw-feature sbtw-pad" style="padding-top:0;" data-screen-label="SPA features">
  <div class="sbtw-wrap">
    <div class="sbtw-two-col">
      <div class="sbtw-media sbtw-reveal sbtw-media-carousel" data-carousel>
        <div class="sbtw-mc-track">
          <?php echo sbt_t1_img( 'C.spa.gallery_1.0', sbt_t1_asset( 'assets/images/great-hall.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
          <?php echo sbt_t1_img( 'C.spa.gallery_2.0', sbt_t1_asset( 'assets/images/courtyard.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
          <?php echo sbt_t1_img( 'C.spa.gallery_3.0', sbt_t1_asset( 'assets/images/bedroom-2.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
        </div>
    ...
    <div class="sbtw-two-col">
      ...
      <div class="sbtw-media sbtw-reveal sbtw-media-carousel" data-carousel>
        <div class="sbtw-mc-track">
          <?php echo sbt_t1_img( 'C.spa.gallery_4.0', sbt_t1_asset( 'assets/images/courtyard.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
          <?php echo sbt_t1_img( 'C.spa.gallery_5.0', sbt_t1_asset( 'assets/images/bedroom-1.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
          <?php echo sbt_t1_img( 'C.spa.gallery_6.0', sbt_t1_asset( 'assets/images/aerial-pool.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
        </div>
        <button class="sbtw-mc-nav sbtw-mc-prev" type="button" aria-label="Previous">&#8249;</button>
        <button class="sbtw-mc-nav sbtw-mc-next" type="button" aria-label="Next">&#8250;</button>
        <div class="sbtw-mc-dots"></div>
