...
$PAGE_TITLE = 'Price &amp; Condition – Masseria Montefieno';
require __DIR__ . '/header/header.php';
?>
<section class="sbtw-page-hero" data-screen-label="Price banner">
  <img class="sbtw-bg" src="<?php echo esc_url( sbt_asset_url( 'assets/images/mf-16.jpg' ) ); ?>" alt="Price & Condition" />
  <div class="sbtw-wrap">
    <div class="sbtw-overline">Rates &amp; reservations</div>
    <h1>Price &amp; Condition</h1>
    <nav class="sbtw-crumb"><a href="<?php echo esc_url( sbt_t1_url( 'index.php' ) ); ?>">Home</a><span>/</span>Accommodation<span>/</span>Price &amp; Condition</nav>
  </div>
</section>
...
<section class="sbtw-pad" data-screen-label="Price intro">
  <div class="sbtw-wrap">
    <div class="sbtw-section-head sbtw-reveal">
      ...
      <p>Check live availability and the best rates, then confirm your reservation in a few secure steps — instant booking, no waiting for a reply.</p>
    </div>
    <div class="sbtw-book-cta sbtw-reveal">
      <div class="sbtw-bc-text">
        ...
        <p>Select your dates, see live prices and complete your reservation through our secure booking system.</p>
      </div>
      <div class="sbtw-bc-action">
        <a class="sbtw-btn" href="https://syncbooking.com">Book your stay</a>
...
<section class="sbtw-pad" style="background:var(--surface);" data-screen-label="Conditions">
  <div class="sbtw-wrap">
    ...
    <dl class="sbtw-cond-list sbtw-reveal">
      ...
      <div class="sbtw-row"><dt>Included</dt><dd>Final cleaning, bed linen and towels, pool towels, Wi-Fi, pool and grounds access.</dd></div>
...
<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_asset_url( 'assets/images/mf-12.jpg' ) ); ?>');" data-screen-label="Price CTA">
