...
<section class="sbtw-page-hero" data-screen-label="Price banner">
  <?php echo sbt_t1_img( 'C.price.hero_bg', sbt_gallery_src( ( isset( $C['price']['hero_bg'] ) && $C['price']['hero_bg'] !== '' ) ? $C['price']['hero_bg'] : 'mf-16.jpg' ), $p['h1'] ?? 'Price & Condition', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
...
<section class="sbtw-pad" data-screen-label="Price intro">
  <div class="sbtw-wrap">
    <div class="sbtw-section-head sbtw-reveal">
      ...
      <p><?php echo sbt_t1_text( 'C.price.intro_p', $p['intro_p'] ?? 'Check live availability and the best rates, then confirm your reservation in a few secure steps — instant booking, no waiting for a reply.', array( 'multiline' => true ) ); ?></p>
    </div>
    <div class="sbtw-book-cta sbtw-reveal">
      <div class="sbtw-bc-text">
        ...
        <p><?php echo sbt_t1_text( 'C.price.bc_p', $p['bc_p'] ?? 'Select your dates, see live prices and complete your reservation through our secure booking system.', array( 'multiline' => true ) ); ?></p>
      </div>
