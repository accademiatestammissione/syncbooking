...
<footer data-screen-label="Footer">
  <div class="wrap">
    <div class="foot-grid">
      <div class="reveal">
        <a class="logo" href="<?php echo function_exists('sbt_url') ? sbt_url('index.php') : 'index.php' ?>"><img src="<?php echo $IMG['logo_foot'] ?>" alt="<?php echo $SITE['name'] ?>" /></a>
      </div>
      <div class="reveal">
      ...
      <div class="reveal">
        <h4><?php echo $TEXT['contacts'] ?? 'Contacts' ?></h4>
        <p>
          <a href="tel:<?php echo $SITE['phone1_t'] ?>">T. <?php echo $SITE['phone1'] ?></a><br>
          <a href="tel:<?php echo $SITE['phone2_t'] ?>">T. <?php echo $SITE['phone2'] ?></a><br>
          <a href="mailto:<?php echo $SITE['email'] ?>"><?php echo $SITE['email'] ?></a>
        </p>
      </div>
      <div class="reveal">
        <h4><?php echo $TEXT['stay_in_touch'] ?? 'Stay in touch' ?></h4>
        <div class="socials">
    ...
    <div class="legal">
      <span>© <?php echo $SITE['year'] ?> <?php echo $SITE['name'] ?> — <?php echo $SITE['tagline'] ?> · VAT <?php echo $SITE['vat'] ?> · CIN <?php echo $SITE['cin'] ?> · <?php echo $TEXT['all_rights_reserved'] ?? 'All rights reserved' ?></span>
      <span style="display:flex;gap:18px;"><a href="#"><?php echo $TEXT['privacy_policy'] ?? 'Privacy Policy' ?></a><a href="<?php echo $SITE['webdev']['url'] ?>"><?php echo $SITE['webdev']['label'] ?></a></span>
    </div>
  </div>
</footer>
