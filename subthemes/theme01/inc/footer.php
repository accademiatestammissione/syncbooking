...
$THEME_JS_VERSION = defined( 'SBT_VERSION' ) ? SBT_VERSION : ( $SOURCE_VERSION ?? '2.1' );
	...
	<div class="sbtw-wrap wrap">
		<div class="sbtw-foot-grid foot-grid">
			<div class="sbtw-reveal reveal">
				<a class="sbtw-logo logo" href="<?php echo esc_url( sbt_t1_url( 'index.php' ) ); ?>"><img src="<?php echo esc_url( sbt_t1_asset( $IMG['logo_foot'] ?? ( $IMG['logo'] ?? '' ) ) ); ?>" alt="<?php echo esc_attr( $SITE['name'] ); ?>" /></a>
			</div>
			<div class="sbtw-reveal reveal">
				<h4><?php echo esc_html( $SITE['name'] ); ?></h4>
				<p><a href="<?php echo esc_url( $SITE['map'] ); ?>"><?php echo wp_kses_post( $SITE['address'] ); ?></a></p>
			</div>
			<div class="sbtw-reveal reveal">
