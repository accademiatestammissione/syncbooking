...
<section class="sbtw-page-hero" data-screen-label="Price banner">
  <?php echo sbt_t1_img( 'C.price.image_1', sbt_t1_asset( 'uploads/Esterni/082.jpg' ), '', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
    ...
    <nav class="sbtw-crumb"><a href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.price.link_1', 'home.php' ) ) ); ?>"><?php echo sbt_t1_text( 'C.price.text_3', 'Home', array( 'multiline' => false ) ); ?></a><span>/</span><a href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.price.link_2', 'houses.php' ) ) ); ?>"><?php echo sbt_t1_text( 'C.price.text_4', 'Houses', array( 'multiline' => false ) ); ?></a><span>/</span><?php echo sbt_t1_text( 'C.price.text_5', 'Price &amp; Condition', array( 'multiline' => false ) ); ?></nav>
  </div>
</section>
...
<section class="sbtw-pad" data-screen-label="Price intro">
  <div class="sbtw-wrap">
    <div class="sbtw-section-head sbtw-reveal">
      ...
      <p><?php echo sbt_t1_text( 'C.price.text_8', 'Check live availability and the best rates for each house, then confirm your reservation in a few secure steps — instant booking, no waiting for a reply.', array( 'multiline' => true ) ); ?></p>
    </div>
    <div class="sbtw-book-cta sbtw-reveal">
      <div class="sbtw-bc-text">
        ...
        <p><?php echo sbt_t1_text( 'C.price.text_11', 'Select your house, see live prices for your dates and complete your reservation through our secure booking system.', array( 'multiline' => true ) ); ?></p>
      </div>
      <div class="sbtw-bc-action">
        <a class="sbtw-btn" href="https://villarosaresort.it/booking"><?php echo sbt_t1_text( 'C.price.text_12', 'Book your stay', array( 'multiline' => false ) ); ?></a>
...
<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_t1_asset( 'uploads/Esterni/090.jpg' ) ); ?>');" data-screen-label="Price CTA">
  <div class="sbtw-inner sbtw-reveal">
    ...
    <a class="sbtw-btn sbtw-btn--light" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.price.link_4', 'contacts.php' ) ) ); ?>" style="margin-top:8px;"><?php echo sbt_t1_text( 'C.price.text_30', 'Contact us', array( 'multiline' => false ) ); ?></a>
  </div>
</section>
