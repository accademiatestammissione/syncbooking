...
<section class="sbtw-hero hero" id="top" data-screen-label="Hero">
	<div class="sbtw-hero-video hero-video">
	...
	<div class="sbtw-hero-overlay hero-overlay"></div>
	<div class="sbtw-hero-inner hero-inner">
		<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.hero_over', $p['hero_over'] ); ?></div>
		<h1><?php echo sbt_t1_text( 'C.home.hero_h1', $p['hero_h1'], array( 'multiline' => true ) ); ?></h1>
		<p class="sbtw-sub sub"><?php echo sbt_t1_text( 'C.home.hero_sub', $p['hero_sub'], array( 'multiline' => true ) ); ?></p>
	</div>
	<div class="sbtw-scrolldown scrolldown"><span><?php echo sbt_t1_text( 'C.home.scroll_label', $p['scroll_label'] ); ?></span><span class="sbtw-line line"></span></div>
</section>

<section class="sbtw-pad pad" id="welcome" data-screen-label="Welcome">
	<div class="sbtw-wrap wrap">
		<div class="sbtw-two-col two-col">
			<div class="sbtw-reveal reveal">
				<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.welcome_over', $p['welcome_over'] ); ?></div>
				<h2 class="sbtw-lead lead"><?php echo sbt_t1_text( 'C.home.welcome_h2', $p['welcome_h2'], array( 'multiline' => true ) ); ?></h2>
				<p class="sbtw-body-text body-text"><?php echo sbt_t1_text( 'C.home.welcome_p1', $p['welcome_p1'], array( 'multiline' => true ) ); ?></p>
				<p class="sbtw-body-text body-text" style="margin-top:18px;"><?php echo sbt_t1_text( 'C.home.welcome_p2', $p['welcome_p2'], array( 'multiline' => true ) ); ?></p>
				<a class="sbtw-btn sbtw-btn--ghost btn btn--ghost" href="<?php echo esc_url( sbt_t1_url( $p['welcome_url'] ) ); ?>" style="margin-top:30px;"><?php echo sbt_t1_text( 'TEXT.discover_villa', $TEXT['discover_villa'] ); ?></a>
			...
			<div class="sbtw-media sbtw-reveal sbtw-media-carousel media reveal media-carousel" data-carousel>
				...
				<div class="sbtw-stamp stamp"><?php echo sbt_t1_text( 'C.home.welcome_stamp', $p['welcome_stamp'], array( 'multiline' => true ) ); ?></div>
			</div>
		</div>
	</div>
</section>
...
<?php if ( ! function_exists( 'sbt_is_entire_rental_mode' ) || ! sbt_is_entire_rental_mode( 'theme01' ) ) : ?>
<section class="sbtw-houses sbtw-pad houses pad" id="houses" data-screen-label="Houses">
	<div class="sbtw-wrap wrap">
		<div class="sbtw-section-head sbtw-reveal section-head reveal">
			<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.houses_over', $p['houses_over'] ); ?></div>
		...
		<div class="sbtw-house-grid house-grid">
			<?php foreach ( $HOUSE_CARDS as $index => $house ) : ?>
				<div class="sbtw-house sbtw-reveal house reveal">
					<div class="sbtw-ph ph">
						<span class="sbtw-tag tag"><?php echo sbt_t1_text( 'HOUSE_CARDS.' . $index . '.tag', $house['tag'] ); ?></span>
						<div class="sbtw-media-carousel media-carousel" data-carousel>
							<div class="sbtw-mc-track mc-track">
					...
					<div class="sbtw-body body">
						<h3><?php echo sbt_t1_text( 'HOUSE_CARDS.' . $index . '.title', $house['title'] ); ?></h3>
						<a class="sbtw-btn sbtw-btn--light sbtw-house-cta btn btn--light house-cta" href="<?php echo esc_url( sbt_t1_url( $house['url'] ) ); ?>"><?php echo sbt_t1_text( 'TEXT.discover', $TEXT['discover'] ); ?></a>
...
<section class="sbtw-services sbtw-pad services pad" id="services" data-screen-label="Services">
	<div class="sbtw-wrap wrap">
		<div class="sbtw-section-head sbtw-reveal section-head reveal">
			<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.services_over', $p['services_over'] ); ?></div>
			<h2><?php echo sbt_t1_text( 'C.home.services_h2', $p['services_h2'] ); ?></h2>
		</div>
		<div class="sbtw-svc-grid svc-grid">
			<?php foreach ( $SERVICES as $index => $service ) : ?>
				<div class="sbtw-svc sbtw-reveal svc reveal">
...
<section class="sbtw-band band" id="band" style="<?php echo esc_attr( sbt_t1_bg_style( 'C.home.band_bg', $p['band_bg'] ) ); ?>" data-screen-label="Surroundings band">
	<div class="sbtw-inner sbtw-reveal inner reveal">
		<?php echo sbt_t1_control( 'C.home.band_bg', $p['band_bg'], 'Background image', 'image' ); ?>
		<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.band_over', $p['band_over'] ); ?></div>
...
<section class="sbtw-feature sbtw-pad feature pad" data-screen-label="SPA & Experience">
	<div class="sbtw-wrap wrap">
		<div class="sbtw-two-col two-col" id="spa">
			<?php sbt_t1_carousel( 'C.home.spa_gallery', $p['spa_gallery'], 'SPA & Wellness', true, true ); ?>
			<div class="sbtw-reveal reveal">
				<div class="sbtw-label label"><?php echo sbt_t1_text( 'C.home.spa_label', $p['spa_label'] ); ?></div>
				<h3><?php echo sbt_t1_text( 'C.home.spa_teaser_h3', $p['spa_teaser_h3'] ); ?></h3>
				<p class="sbtw-body-text body-text"><?php echo sbt_t1_text( 'C.home.spa_teaser_p', $p['spa_teaser_p'], array( 'multiline' => true ) ); ?></p>
				<a class="sbtw-btn sbtw-btn--ghost btn btn--ghost" href="<?php echo esc_url( sbt_t1_url( $p['spa_teaser_url'] ) ); ?>" style="margin-top:28px;"><?php echo sbt_t1_text( 'TEXT.discover_spa', $TEXT['discover_spa'] ); ?></a>
				<?php echo sbt_t1_control( 'C.home.spa_teaser_url', $p['spa_teaser_url'], 'Button link', 'url' ); ?>
			</div>
		</div>
		<div class="sbtw-two-col two-col" id="experience">
			<div class="sbtw-reveal reveal">
				<div class="sbtw-label label"><?php echo sbt_t1_text( 'C.home.experience_label', $p['experience_label'] ); ?></div>
				<h3><?php echo sbt_t1_text( 'C.home.experience_teaser_h3', $p['experience_teaser_h3'] ); ?></h3>
				<p class="sbtw-body-text body-text"><?php echo sbt_t1_text( 'C.home.experience_teaser_p', $p['experience_teaser_p'], array( 'multiline' => true ) ); ?></p>
				<a class="sbtw-btn sbtw-btn--ghost btn btn--ghost" href="<?php echo esc_url( sbt_t1_url( $p['experience_teaser_url'] ) ); ?>" style="margin-top:28px;"><?php echo sbt_t1_text( 'TEXT.explore_experiences', $TEXT['explore_experiences'] ); ?></a>
...
<section class="sbtw-offers offers" id="offers" data-screen-label="Offers">
	<div class="sbtw-wrap sbtw-inner sbtw-reveal wrap inner reveal">
		<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.offers_over', $p['offers_over'] ); ?></div>
		<h2><?php echo sbt_t1_text( 'C.home.offers_h2', $p['offers_h2'] ); ?></h2>
		<p class="sbtw-body-text body-text" style="margin:0 auto 36px;color:rgba(255,255,255,.88);max-width:50ch;"><?php echo sbt_t1_text( 'C.home.offers_p', $p['offers_p'], array( 'multiline' => true ) ); ?></p>
		<a class="sbtw-btn sbtw-btn--light btn btn--light" href="<?php echo esc_url( sbt_t1_url( $p['offers_url'] ) ); ?>"><?php echo sbt_t1_text( 'C.home.offers_btn', $p['offers_btn'] ); ?></a>
...
?>
<section class="sbtw-cta-band cta-band" id="house-cta" style="<?php echo esc_attr( sbt_t1_bg_style( 'C.home.house_cta_bg', $p['house_cta_bg'] ) ); ?>" data-screen-label="Houses CTA">
	<div class="sbtw-inner sbtw-reveal inner reveal">
		<?php echo sbt_t1_control( 'C.home.house_cta_bg', $p['house_cta_bg'], 'Background image', 'image' ); ?>
		<div class="sbtw-overline overline"><?php echo sbt_t1_text( 'C.home.house_cta_over', $p['house_cta_over'] ); ?></div>
		<h2><?php echo sbt_t1_text( 'C.home.house_cta_h2', $home_cta_h2, array( 'multiline' => true ) ); ?></h2>
		<a class="sbtw-btn sbtw-btn--light btn btn--light" href="<?php echo esc_url( sbt_t1_url( $home_cta_url ) ); ?>"><?php echo sbt_t1_text( 'C.home.house_cta_btn', $home_cta_btn ); ?></a>
