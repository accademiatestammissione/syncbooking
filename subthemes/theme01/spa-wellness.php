...
<section class="sbtw-feature sbtw-pad" style="padding-top:0;" data-screen-label="SPA features">
  <div class="sbtw-wrap">
    <div class="sbtw-two-col">
      <div class="sbtw-media sbtw-reveal sbtw-media-carousel" data-carousel>
        <div class="sbtw-mc-track">
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/jacuzzi.png' ) ); ?>" alt="Hydromassage pool" />
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/hammam.png' ) ); ?>" alt="Hammam" />
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/turkish-bath.png' ) ); ?>" alt="Turkish bath" />
        </div>
    ...
    <div class="sbtw-two-col">
      ...
      <div class="sbtw-media sbtw-reveal sbtw-media-carousel" data-carousel>
        <div class="sbtw-mc-track">
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/sauna.png' ) ); ?>" alt="Finnish sauna" />
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/relax-area.png' ) ); ?>" alt="Relax area" />
          <img data-lightbox src="<?php echo esc_url( sbt_asset_url( 'assets/images/gym.png' ) ); ?>" alt="Gym" />
        </div>
        <button class="sbtw-mc-nav sbtw-mc-prev" type="button" aria-label="Previous">&#8249;</button>
        <button class="sbtw-mc-nav sbtw-mc-next" type="button" aria-label="Next">&#8250;</button>
        <div class="sbtw-mc-dots"></div>
