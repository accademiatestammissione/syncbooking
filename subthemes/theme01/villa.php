...
<section class="sbtw-page-hero" data-screen-label="Villa banner">
  <?php echo sbt_t1_img( 'C.villa.image_1', sbt_t1_asset( 'uploads/Esterni/085.jpg' ), '', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
    <div class="sbtw-overline"><?php echo sbt_t1_text( 'C.villa.text_1', 'Villa Rosa Resort &amp; SPA', array( 'multiline' => false ) ); ?></div>
    <h1><?php echo sbt_t1_text( 'C.villa.text_2', 'The Villa', array( 'multiline' => false ) ); ?></h1>
    <nav class="sbtw-crumb"><a href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.villa.link_1', 'home.php' ) ) ); ?>"><?php echo sbt_t1_text( 'C.villa.text_3', 'Home', array( 'multiline' => false ) ); ?></a><span>/</span><?php echo sbt_t1_text( 'C.villa.text_4', 'Villa', array( 'multiline' => false ) ); ?></nav>
  </div>
</section>
...
<section class="sbtw-pad" data-screen-label="Villa intro">
  <div class="sbtw-wrap sbtw-two-col">
    ...
    <div class="sbtw-reveal">
      ...
      <p class="sbtw-body-text" style="max-width:54ch;margin-top:18px;"><?php echo sbt_t1_text( 'C.villa.text_10', 'Attention to detail, refined design, a mix of modern and ancient, a stone\'s throw from monuments and shops — the houses of Villa Rosa, with private external pergolas, also offer the typical comforts of a resort.', array( 'multiline' => true ) ); ?></p>
    </div>
  </div>
</section>
...
<section class="sbtw-pad-s" style="padding-top:0;" data-screen-label="Villa gallery">
  <div class="sbtw-wrap">
    <div class="sbtw-gallery">
      <?php echo sbt_t1_img( 'C.villa.gallery_1.0', sbt_t1_asset( 'uploads/ota/067.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
      <?php echo sbt_t1_img( 'C.villa.gallery_2.0', sbt_t1_asset( 'uploads/ota/001.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
      <?php echo sbt_t1_img( 'C.villa.gallery_3.0', sbt_t1_asset( 'uploads/ota/048.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
      <?php echo sbt_t1_img( 'C.villa.gallery_4.0', sbt_t1_asset( 'uploads/ota/094.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
      <?php echo sbt_t1_img( 'C.villa.gallery_5.0', sbt_t1_asset( 'uploads/Esterni/087.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
      <?php echo sbt_t1_img( 'C.villa.gallery_6.0', sbt_t1_asset( 'uploads/Esterni/081.jpg' ), '', array( 'data-lightbox' => '' ) ); ?>
    </div>
  </div>
</section>
...
<!-- ============ BAND CTA ============ -->
<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_t1_asset( 'uploads/Esterni/072.jpg' ) ); ?>');" data-screen-label="Villa CTA">
  <div class="sbtw-inner sbtw-reveal">
    <div class="sbtw-overline"><?php echo sbt_t1_text( 'C.villa.text_26', 'Your private retreat awaits', array( 'multiline' => false ) ); ?></div>
    <h2><?php echo sbt_t1_text( 'C.villa.text_27', 'Choose your house in Villa Rosa', array( 'multiline' => false ) ); ?></h2>
    <a class="sbtw-btn sbtw-btn--light" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.villa.link_2', 'houses.php' ) ) ); ?>" style="margin-top:8px;"><?php echo sbt_t1_text( 'C.villa.text_28', 'Explore the houses', array( 'multiline' => false ) ); ?></a>
  </div>
</section>
