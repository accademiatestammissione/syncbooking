...
<section class="sbtw-page-hero" data-screen-label="Surroundings banner">
  <?php echo sbt_t1_img( 'C.surroundings.hero_bg', sbt_gallery_src( ( isset( $C['surroundings']['hero_bg'] ) && $C['surroundings']['hero_bg'] !== '' ) ? $C['surroundings']['hero_bg'] : 'conversano-town.jpg' ), $SITE['name'] ?? 'Surroundings', array( 'class' => 'sbtw-bg' ) ); ?>
  <div class="sbtw-wrap">
