...
<section class="sbtw-page-hero" data-screen-label="Contacts banner">
  <img class="sbtw-bg" src="<?php echo esc_url( sbt_asset_url( 'assets/images/exterior-086.jpg' ) ); ?>" alt="Contacts" />
  <div class="sbtw-wrap">
    ...
    <div class="sbtw-contact-grid">
      <div class="sbtw-contact-info sbtw-reveal">
        <div class="sbtw-ci-block">
          ...
          <p class="sbtw-big">Viale P. Orlando, 1<br/>70014 Conversano (Bari)<br/>Puglia, Italy</p>
          <p style="margin-top:8px;"><a href="https://maps.app.goo.gl/PjihQ243sU2ZcT4m9">Open in Google Maps →</a></p>
        </div>
        <div class="sbtw-ci-block">
          <div class="sbtw-overline">Phone</div>
          <p class="sbtw-big"><a href="tel:+393382507545">+39 338 250 7545</a><br/><a href="tel:+393206090558">+39 320 609 0558</a></p>
        ...
        <div class="sbtw-ci-block">
          ...
          <p class="sbtw-big"><a href="mailto:villarosasuites@gmail.com">villarosasuites@gmail.com</a></p>
        </div>
      </div>
