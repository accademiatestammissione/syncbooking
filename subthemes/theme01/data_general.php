...
$IMG = array(
	...
	'a1' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/exterior-087.jpg' ) : 'assets/images/exterior-087.jpg',
	'a5' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/exterior-072.jpg' ) : 'assets/images/exterior-072.jpg',
	'room' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-001.jpg' ) : 'assets/images/interior-001.jpg',
	'room2' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-067.jpg' ) : 'assets/images/interior-067.jpg',
	'garden' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/exterior-081.jpg' ) : 'assets/images/exterior-081.jpg',
	'villa' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/exterior-090.jpg' ) : 'assets/images/exterior-090.jpg',
	'lunch' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/apulian-breakfast.jpg' ) : 'assets/images/apulian-breakfast.jpg',
	'spa_remote' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/wellness-corridor.jpg' ) : 'assets/images/wellness-corridor.jpg',
	...
	'room_detail' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-004.jpg' ) : 'assets/images/interior-004.jpg',
	'h2a' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-112.jpg' ) : 'assets/images/interior-112.jpg',
	'h2b' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-120.jpg' ) : 'assets/images/interior-120.jpg',
	'h2c' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-132.jpg' ) : 'assets/images/interior-132.jpg',
	'h3a' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-134.jpg' ) : 'assets/images/interior-134.jpg',
	'h3b' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-136.jpg' ) : 'assets/images/interior-136.jpg',
	'h3c' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-139.jpg' ) : 'assets/images/interior-139.jpg',
	'h4a' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-147.jpg' ) : 'assets/images/interior-147.jpg',
	'h4b' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-153.jpg' ) : 'assets/images/interior-153.jpg',
	'h4c' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-167.jpg' ) : 'assets/images/interior-167.jpg',
	'h4d' => function_exists( 'sbt_asset_url' ) ? sbt_asset_url( 'assets/images/interior-177.jpg' ) : 'assets/images/interior-177.jpg',
...
$SITE = array(
	...
	'color_footer_bg' => '#8a463f',
	'color_footer_text' => '#e0c9c3',
	'color_header' => '#8a463f',
...
$C['home'] = array(
	...
	'entire_url' => 'whole-villa.php',
	'entire_btn' => 'Discover entire villa',
	'entire_specs' => array( array( 'Guests', 'Up to 10' ), array( 'Use', 'Entire estate, exclusive' ) ),
	...
	'services' => array(
		array( 'Pool', 'Enjoy our pool in the green garden, perfect for relaxing and sunbathing.' ),
		array( 'Park', 'An oasis of tranquility, ideal for walks and moments of relaxation outdoors.' ),
		array( 'SPA', 'Turkish bath, hot tub, sauna and massage room for a unique wellness experience.' ),
		array( 'Wi-Fi', 'To be, if you want, always reachable across the whole property.' ),
		array( 'Equipped Kitchen', 'Each house has a full kitchen, to prepare your meals in complete independence.' ),
		array( 'BBQ', 'Our BBQ area in the park - the experience of grilling outdoors in style.' ),
		array( 'Car Rental', 'A car rental service, to enjoy every part of Puglia independently.' ),
		array( 'Gym', 'To keep perfectly fit, even on holiday.' ),
	),
...
$C['houses'] = array(
	...
	'gallery_over' => 'A look inside',
	'gallery_h2' => 'Rooms & spaces',
	'gallery_p' => 'Bedrooms, living areas, kitchens and bathrooms — a glimpse of the interiors that make every Villa Rosa house a private home.',
...
$C['house2'] = array(
	...
	'banner' => $IMG['welcome'],
	'main' => $IMG['a1'],
	'card_gallery' => array( $IMG['h2a'], $IMG['h2b'], $IMG['h2c'] ),
	'overview_gallery' => array( $IMG['h2a'], $IMG['h2b'], $IMG['h2c'] ),
...
$C['house3'] = array_replace( $C['house2'], array(
	...
	'banner' => $IMG['garden'],
	'main' => $IMG['room'],
	'card_gallery' => array( $IMG['h3a'], $IMG['h3b'], $IMG['h3c'] ),
	'overview_gallery' => array( $IMG['h3a'], $IMG['h3b'], $IMG['h3c'] ),
...
$C['house4'] = array_replace( $C['house2'], array(
	...
	'banner' => $IMG['villa'],
	'main' => $IMG['room2'],
	'card_gallery' => array( $IMG['h4a'], $IMG['h4b'], $IMG['h4c'], $IMG['h4d'] ),
	'overview_gallery' => array( $IMG['h4a'], $IMG['h4b'], $IMG['h4c'], $IMG['h4d'] ),
