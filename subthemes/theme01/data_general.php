...
$C['home'] = [
  ...
  'welcome_gallery' => [$IMG['welcome'], $IMG['a1'], $IMG['a5'], $IMG['room'], $IMG['garden']],
...
$C['price'] = [
  ...
  'gallery'=>[
    function_exists('sbt_asset_url') ? sbt_asset_url('assets/images/jacuzzi.jpg') : 'assets/images/jacuzzi.jpg',
    function_exists('sbt_asset_url') ? sbt_asset_url('assets/images/sauna.jpg') : 'assets/images/sauna.jpg',
    function_exists('sbt_asset_url') ? sbt_asset_url('assets/images/turkish-bath.jpg') : 'assets/images/turkish-bath.jpg',
