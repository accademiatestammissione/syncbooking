<?php $PAGE = 'experiences'; require __DIR__ . '/inc/header.php'; $p = $C['experiences']; ?>
...
<section class="page-hero" data-screen-label="Experiences banner">
  ...
  <div class="wrap">
    ...
    <h1><?= $p['h1'] ?></h1>
    <nav class="crumb"><a href="<?= function_exists('sbt_url') ? sbt_url('index.php') : 'index.php' ?>"><?= $TEXT['home'] ?></a><span>/</span>Experiences</nav>
  </div>
</section>
    ...
    <div class="exp-grid">
      ...
      <article class="exp reveal">
        ...
        <div class="ex-body">
          ...
          <a class="ex-link" href="<?= function_exists('sbt_url') ? sbt_url('contacts.php') : 'contacts.php' ?>"><?= $TEXT['enquire'] ?> <span></span></a>
        </div>
      </article>
      <?php endforeach; ?>
    </div>
