...
<section class="sbtw-page-hero" data-screen-label="Experiences banner">
  ...
  <div class="sbtw-wrap">
    <div class="sbtw-overline"><?php echo sbt_t1_text( 'C.experiences.text_1', 'Villa Rosa Resort &amp; SPA', array( 'multiline' => false ) ); ?></div>
...
<section class="sbtw-pad" data-screen-label="Experiences intro">
  <div class="sbtw-wrap">
    ...
    <div class="sbtw-exp-grid">
      <a class="sbtw-exp sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.experiences.link_2', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.experiences.image_2', sbt_t1_asset( 'uploads/ota/039.jpg' ), '', array() ); ?><div class="sbtw-ex-body"><div class="sbtw-overline"><?php echo sbt_t1_text( 'C.experiences.text_8', 'Taste', array( 'multiline' => false ) ); ?></div><h3><?php echo sbt_t1_text( 'C.experiences.text_9', 'Cooking Classes', array( 'multiline' => false ) ); ?></h3><div class="sbtw-ex-link"><?php echo sbt_t1_text( 'C.experiences.text_10', 'Discover', array( 'multiline' => false ) ); ?> <span></span></div></div></a>
      <a class="sbtw-exp sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.experiences.link_3', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.experiences.image_3', sbt_t1_asset( 'uploads/ota/005.jpg' ), '', array() ); ?><div class="sbtw-ex-body"><div class="sbtw-overline"><?php echo sbt_t1_text( 'C.experiences.text_11', 'Cellar', array( 'multiline' => false ) ); ?></div><h3><?php echo sbt_t1_text( 'C.experiences.text_12', 'Wine Tastings', array( 'multiline' => false ) ); ?></h3><div class="sbtw-ex-link"><?php echo sbt_t1_text( 'C.experiences.text_13', 'Discover', array( 'multiline' => false ) ); ?> <span></span></div></div></a>
      <a class="sbtw-exp sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.experiences.link_4', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.experiences.image_4', sbt_t1_asset( 'https://commons.wikimedia.org/wiki/Special:FilePath/Alberobello%20trulli.JPG?width=1400' ), '', array() ); ?><div class="sbtw-ex-body"><div class="sbtw-overline"><?php echo sbt_t1_text( 'C.experiences.text_14', 'Discover', array( 'multiline' => false ) ); ?></div><h3><?php echo sbt_t1_text( 'C.experiences.text_15', 'Private Tours', array( 'multiline' => false ) ); ?></h3><div class="sbtw-ex-link"><?php echo sbt_t1_text( 'C.experiences.text_16', 'Discover', array( 'multiline' => false ) ); ?> <span></span></div></div></a>
      <a class="sbtw-exp sbtw-reveal" href="<?php echo esc_url( sbt_t1_url( sbt_t1_value( 'C.experiences.link_5', 'single.php' ) ) ); ?>"><?php echo sbt_t1_img( 'C.experiences.image_5', sbt_t1_asset( 'https://commons.wikimedia.org/wiki/Special:FilePath/Lama%20Monachile.jpg?width=1400' ), '', array() ); ?><div class="sbtw-ex-body"><div class="sbtw-overline"><?php echo sbt_t1_text( 'C.experiences.text_17', 'Sea', array( 'multiline' => false ) ); ?></div><h3><?php echo sbt_t1_text( 'C.experiences.text_18', 'Coast &amp; Beaches', array( 'multiline' => false ) ); ?></h3><div class="sbtw-ex-link"><?php echo sbt_t1_text( 'C.experiences.text_19', 'Discover', array( 'multiline' => false ) ); ?> <span></span></div></div></a>
    </div>
  </div>
</section>
...
<section class="sbtw-band" style="background-image:url('<?php echo esc_url( sbt_t1_asset( 'assets/images/wellness-corridor.jpg' ) ); ?>');" data-screen-label="Experiences band">
  <div class="sbtw-inner sbtw-reveal">
    ...
    <p><?php echo sbt_t1_text( 'C.experiences.text_27', 'Long lunches under the pergola, sun-warmed stone, and the generous welcome of the South — this is the rhythm of a stay at Villa Rosa.', array( 'multiline' => true ) ); ?></p>
  </div>
</section>
