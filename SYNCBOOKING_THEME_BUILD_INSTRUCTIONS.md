...
- Do not bundle demo uploads or `subthemes/*/assets` directories in the theme zip; assets are downloaded online from the configured `assets.zip` after activation.
